...
let expectedData = {
    Id: 'annans-1',
    CName: 'Ben', CLastName: 'Ingvarsson', CAdress: { street: 'Storgatan 2b', zip: '123 45', city: 'Testra', Country: 'Sweden' }, Payment: 'credit card', Price: '250kr', OrderNumber: '123456789', OrderDate: '2019-10/03', Delivery: 'Utlämningsställe',
...
describe('Order', () => {
    ...
    test('sending orderinformation', () => {
        ...
        wrapper.vm.setTShirtAnnan(expectedData.Id)
        ...
        expect(wrapper.vm.orderData.AnnanId).toEqual(expectedData.Id)
